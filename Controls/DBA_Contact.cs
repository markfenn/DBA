...
namespace DowntownBoiseAssociation.Controls
{
    ...
    public partial class DBA_Contact : UserControl
    {
        ...
        {
            set { _AddressIdNow = value; }
            get { return _AddressIdNow; }
        }
        ...
        private void addressLE_AddressChange(object source, int inAddressId)
        {
            try
            {
                //_ContactInfo.AddressId = AddressId;
                addressLE.AddressId = inAddressId;
            }
            catch { }
            _AddressIdNow = inAddressId;
            AddressId = inAddressId;
        }

        public void Save()
        {
            addressLE.AddressId = _AddressIdNow;
            //if (_ExistingItem)
            //{
        ...
        private void lbnChangeContact_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            NewContact.AddressId = _AddressIdNow;
